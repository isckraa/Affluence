 ...
 */
final class Version20200624134816 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE boutique (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, adresse VARCHAR(255) NOT NULL, code_postal VARCHAR(5) NOT NULL, nom VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_A1223C54A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE info_file_attente (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, heure_entree TIME NOT NULL, heure_sortie TIME NOT NULL, type VARCHAR(255) DEFAULT NULL, affluence INT NOT NULL, INDEX IDX_62CD3755A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE file_attente DROP FOREIGN KEY FK_4F10E0F279E43730');
